id: 29
title: express-mysql-ejs员工管理系统模版引擎
date: 2017-01-25
category: nodejs
tags: javascript, nodejs
description: 之前介绍过express、ejs的使用，也介绍了nodejs操作mysql数据库，现在将这些整合起来，做一个简单的员工管理系统
...
![](/images/nodejs/2017/01/25/019.png{width='600px'})
![](/images/nodejs/2017/01/25/020.png{width='600px'})
