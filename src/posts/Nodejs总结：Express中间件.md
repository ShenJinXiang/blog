...
description: 在express中，中间件很重要，完全是由路由和中间件构成的一个web开发框架，本质上来说，一个express应用就是在调用各种中间件
...
<pre class='line-numbers language-none'>
<code>$ touch public/001.html</code>
</pre>
...
<img src='/images/nodejs/2017/01/12/001.png' width='100%' height='160px'/>
<p>每个应用可以配置多个静态目录：</p>
<pre class='line-numbers language-javascript'>
