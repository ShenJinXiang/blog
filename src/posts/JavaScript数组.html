...
<code>var empty = []; // 没有元素的数组
var arr1 = [1, 2, 3, 4, 5]; // 创建5个数值的数组
var arr2 = [1, true, 'abcd', 1.1, {x: 1, y: 2}]; // 元素类型不同的数组</code>
</pre>
<h4>构造函数Array()</h4>
<pre class='line-numbers language-javascript'>
<code>var arr1 = new Array(); // 类似 直接量 []
var arr2 = new Array(10); // 制定数组长度为10
var arr3 = new Array(5, 4, 2, true, 'test', new Object());</code>
</pre>
<h3>数组的读写</h3>
<h4>读取数组元素</h4>
<p>使用[]操作符来访问数组中的元素</p>
<pre class='line-numbers language-javascript'>
<code>var arr1 = ['aa', 'bb', 'cc', 'dd', 'ee'];
console.log(arr1[0]); // aa
console.log(arr1[1]); // bb
console.log(arr1[2]); // cc 
console.log(arr1[3]); // dd
console.log(arr1[4]); // ee
console.log(arr1[5]); // undefined</code>
</pre>
<h4>写入数组元素</h4>
...
console.log(arr.length); // 11</code>
</pre>
<h3>数组的长度</h3>
...
console.log(arr.length); // 6
console.log(1 in arr); // false</code>
</pre>
<h3>稀疏数组</h3>
<p>稀疏数组就是包含从0开始的不连续索引的数组,稀疏数组的length属性大于数组元素的个数</p>
<pre class='line-numbers language-javascript'>
<code>var arr1 = new Array(5);
console.log(arr1); // [ , , , ,  ]
var arr2 = [];
arr2[10] = 0;
console.log(arr2); // [ , , , , , , , , , , 0 ]
console.log(arr2.length); // 11
console.log(arr2[1]); // undefined</code>
</pre>
<h3>数组的遍历</h3>
<h4>使用for循环</h4>
<i>常见的循环方式</i>
...
<pre class='line-numbers language-javascript'>
<code>var arr = [11, 22, 33, 44, 55, 66];
...
<code>index: 0  value: 11
index: 1  value: 22
index: 2  value: 33
index: 3  value: 44
index: 4  value: 55
index: 5  value: 66</code>
</pre>
<h3>数组常用方法</h3>
<h4>push()方法</h4>
...
console.log(arr === arr1); // true</code>
</pre>
<h4>sort()方法</h4>
...
console.log(arr); // [ 1111, 222, 33, 4 ]</code>
</pre>
<i>忽略大小写排序：</i>
<pre class='line-numbers language-javascript'>
<code>var arr = ['ant', 'Bug', 'cat', 'Dog'];
arr.sort();
...
console.log(arr); // [ 'ant', 'Bug', 'cat', 'Dog' ]</code>
</pre>
<h4>concat()方法</h4>
...
console.log(arr4); // [ 1, 2, 3, 4, 5, [ 6, 7 ] ]</code>
</pre>
<h4>slice()方法</h4>
...
console.log(arr); // [ 1, 2, [ 1, 2 ], 3, 3, 4, 5 ]</code>
</pre>
<br>
<h4>map()方法</h4>
...
console.log(arr1); // [ 1, 4, 9, 16, 25, 36, 49, 64, 81 ]</code>
</pre>
<h4>filter()方法</h4>
...
console.log(arr.some(function(){return true;})); // false</code>
</pre>
